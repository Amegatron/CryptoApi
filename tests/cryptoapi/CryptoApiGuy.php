...
use Codeception\Module\CryptoApiHelper;
...
class CryptoApiGuy extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     *
     *
     * @see Codeception\Module\CryptoApiHelper::usePublicCertificate()
     * @return \Codeception\Maybe
     */
    public function usePublicCertificate($publicKeyFile) {
        $this->scenario->addStep(new \Codeception\Step\Action('usePublicCertificate', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\CryptoApiHelper::useAESKey()
     * @return \Codeception\Maybe
     */
    public function useAESKey($key, $iv = null, $keySize = null) {
        $this->scenario->addStep(new \Codeception\Step\Action('useAESKey', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\CryptoApiHelper::seeValidSignature()
     * @return \Codeception\Maybe
     */
    public function canSeeValidSignature() {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeValidSignature', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeValidSignature() {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeValidSignature', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\CryptoApiHelper::seeMessageInResponse()
     * @return \Codeception\Maybe
     */
    public function canSeeMessageInResponse($message) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeMessageInResponse', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeMessageInResponse($message) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeMessageInResponse', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\CryptoApiHelper::enableCookies()
     * @return \Codeception\Maybe
     */
    public function enableCookies() {
        $this->scenario->addStep(new \Codeception\Step\Action('enableCookies', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     * @return \Crypt_AES
     * @see Codeception\Module\CryptoApiHelper::getAes()
     * @return \Codeception\Maybe
     */
    public function getAes() {
        $this->scenario->addStep(new \Codeception\Step\Action('getAes', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     * @return \Crypt_RSA
     * @see Codeception\Module\CryptoApiHelper::getRsa()
     * @return \Codeception\Maybe
     */
    public function getRsa() {
        $this->scenario->addStep(new \Codeception\Step\Action('getRsa', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     * @return mixed
     * @see Codeception\Module\CryptoApiHelper::getAesIV()
     * @return \Codeception\Maybe
     */
    public function getAesIV() {
        $this->scenario->addStep(new \Codeception\Step\Action('getAesIV', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     * @return mixed
     * @see Codeception\Module\CryptoApiHelper::getAesKey()
     * @return \Codeception\Maybe
     */
    public function getAesKey() {
        $this->scenario->addStep(new \Codeception\Step\Action('getAesKey', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
